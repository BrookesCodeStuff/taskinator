...
let createTaskEl = function (taskDataObject) {
  ...
  let statusValue = taskDataObject.status;
...
let taskStatusChangeHandler = function (event) {
  ...
  // Update task status
  tasks[taskId].status = statusValue;
...
// Save tasks in the task array to the task variable in localStorage
...
let loadTasks = function () {
  ...
  // Loop through savedTasks array and create tasks
